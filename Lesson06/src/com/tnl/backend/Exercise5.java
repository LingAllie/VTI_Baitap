...
public class Exercise5 {
	...
	public void question1_2() {
		...
		while (true) {
			...
			// bien choose nam ngoai vong lap nen giu nguyen gia tri
		// vi switch nam trong vong lap while true nen bien choose luon dung nen se luon chay lai voi lua chon ma user da input
		//while(true) {
			switch (choose) {
			case 1:
				qlcb.addCanBo();
